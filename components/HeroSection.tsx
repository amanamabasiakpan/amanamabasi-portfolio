						...
						<div className='relative mx-auto flex max-w-6xl flex-col px-6 lg:block'>
							<div className='mx-auto max-w-xl text-center lg:ml-0 lg:w-1/2 lg:text-left'>
								...
								<p className='mt-5 md:mt-10 max-w-2xl text-pretty text-base md:text-lg'>
									I’m Amanamabasi Akpan a Full-Stack Developer. I build great
									products with clean interfaces that wow users, keep them
									engaged, all while being secure, scalable, and fast.
								</p>
