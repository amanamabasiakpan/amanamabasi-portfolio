    ...
    return (
        <section className="mt-20">
            <div className="mx-auto max-w-4xl px-4 lg:px-0">
                <h1 className="mb-12 text-center text-4xl font-semibold lg:text-5xl">Need a developer for your next project?</h1>

                <div className="grid divide-y border md:grid-cols-2 md:gap-4 md:divide-x md:divide-y-0 bg-card rounded-xl text-center">
                    <div className="flex flex-col justify-between space-y-8 p-6 sm:p-12 ">
                        <div>
                            <h2 className="mb-3 text-lg font-semibold">Email</h2>
                            <Link href="mailto:amanamabasiakpan@gmail.com" className="text-lg text-blue-600 hover:underline dark:text-blue-400">
                                amanamabasiakpan@gmail.com
                            </Link>
                    ...
                    <div className="flex flex-col justify-between space-y-8 p-6 sm:p-12 ">
                        <div>
                            <h3 className="mb-3 text-lg font-semibold">Call</h3>
                            <Link href="tel:+2349077016503" className="text-lg text-blue-600 hover:underline dark:text-blue-400">
                                +234 907 701 6503
                            </Link>
                            {/* <p className="mt-3 text-sm">+243 000 000 000</p> */}
                        </div>
