                ...
                <div className="grid items-center gap-12 md:grid-cols-2 md:gap-12 lg:grid-cols-5 lg:gap-24">
                    <div className="lg:col-span-2 px-6">
                        <div className="md:pr-6 lg:pr-0">
                            ...
                            <p className="mt-6">A Next.js, React, Tailwind CSS, and ShadCN-powered portfolio designed for speed, responsiveness, and a clean user experience. Features smooth animations, dynamic content, and dark/light mode.</p>
                        </div>
                        <ul className="mt-8 divide-y border-y *:flex *:items-center *:gap-3 *:py-3">
                            <li>
                                <Zap className="size-5" />
                                Next.js, React, Tailwind CSS, ShadCN.
                            </li>
